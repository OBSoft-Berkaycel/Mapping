            ...
            <form class="form-horizontal" role="form" method="post">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" id="latitude" class="form-control" name="latitude" autocomplete="off" required oninvalid="this.setCustomValidity('@lang('please_fillout_thisfield')')" oninput="setCustomValidity('')"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" id="longitude" class="form-control" name="longitude" autocomplete="off" required oninvalid="this.setCustomValidity('@lang('please_fillout_thisfield')')" oninput="setCustomValidity('')"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input class="form-control jscolor" type="text" id="color" name="color" value="#605CA8">
                        </div>
                    </div>
                </div>
                <!-- /.box-body -->
